...
public class IsTDDDeadTest {
    ...
    public void should_get_one_tweet() {
        ...
        Map<LocalDate, Long> tweetsByDay = isTDDDead.tweetsByDay();

        assertThat(tweetsByDay).containsExactly(entry(LocalDate.of(1981, Month.DECEMBER, 24), 1L));
    }
    ...
    public void should_get_two_tweets_at_same_date() {
        ...
        assertThat(tweetsByDay).containsExactly(entry(LocalDate.of(1981, Month.DECEMBER, 24), 2L));
    }
    ...
    public void should_get_two_tweets_at_two_dates() {
        ...
        assertThat(tweetsByDay).containsExactly(
                entry(LocalDate.of(1981, Month.DECEMBER, 24), 1L),
                entry(LocalDate.of(2012, Month.SEPTEMBER, 24), 1L)
        );
    }
